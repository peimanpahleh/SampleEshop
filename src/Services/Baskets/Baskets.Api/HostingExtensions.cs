...
public static class HostingExtensions
{
    ...
    private static void UseConsul(this WebApplication app)
    {
        using (var scope = app.Services.CreateScope())
        {
            ...
            //var consulSettings = settings.Value.BasketSettings.ConsulSettings;
            var consulSettings = settings.BasketSettings.ConsulSettings;
    ...
    private static IServiceCollection AddCustomMassTransit(this IServiceCollection services, ServiceSettings settings)
    {
        ...
        services.AddMassTransit(x =>
        {
            ...
            x.AddConsumersFromNamespaceContaining<OrderStartedHandler>();
